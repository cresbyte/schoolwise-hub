        ...
        <EditAssignmentDialog 
          ...
          onSave={async (data) => {
            try {
              ...
              showNotification(err.message || "Failed to update assignment", "error");
            }
          }}
        />
      )}
...
function EditAssignmentDialog({ open, assignment, staff, onClose, onSave }) {
    ...
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
      ...
      <DialogContent sx={{ pt: 1 }}>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, pt: 1 }}>
          <TextField label="Class" value={assignment.className || assignment.classId} disabled fullWidth size="small" />
...
function NewAssignmentDialog({ open, classes, subjects, staff, onClose, onSave }) {
