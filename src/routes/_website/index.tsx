...
export const Route = createFileRoute("/_website/")({
  head: () =>
    websiteHead({
      title: "Home",
      description: `${SCHOOL.name} — ${SCHOOL.tagline}. Premier private day & boarding school in Nakuru offering CBC and 8-4-4 education.`,
    }),
  component: HomePage,
});
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 3 }}>
          <Card sx={{ height: "100%" }}>
            ...
            <CardContent>
              ...
              <Button component={RouterLink} to="/academics#cbc" variant="outlined">
                Learn More
              </Button>
            </CardContent>
          </Card>
          <Card sx={{ height: "100%" }}>
            ...
            <CardContent>
              ...
              <Button component={RouterLink} to="/academics#844" variant="outlined">
                Learn More
              </Button>
            </CardContent>
          </Card>
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", lg: "2fr 1fr" }, gap: 3 }}>
          <Box>
            ...
            <Box sx={{ mt: 3, textAlign: "center" }}>
              <Button component={RouterLink} to="/news" variant="contained">
                View All News
              </Button>
            </Box>
          </Box>
