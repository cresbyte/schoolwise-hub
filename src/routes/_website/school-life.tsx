 ...
 * @module routes/_website/school-life
 */
...
export const Route = createFileRoute("/_website/school-life")({
  head: () =>
    websiteHead({
      title: "School Life",
      description: `Extracurricular life at ${SCHOOL.name} — sports, clubs, arts, leadership, and boarding.`,
    }),
...
/** School life page with tabbed sections and boarding info. */
    ...
    <>
      ...
      <SectionWrapper>
        ...
        >
          ...
          <Tab label="Boarding" id="boarding" sx={{ textTransform: "none", fontWeight: 600 }} />
        </Tabs>
