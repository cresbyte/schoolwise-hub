 ...
 * @module routes/_website/admissions.apply
 */
...
export const Route = createFileRoute("/_website/admissions/apply")({
  head: () =>
    websiteHead({
      title: "Apply Online",
      description: `Submit an online application to ${SCHOOL.name}.`,
    }),
  component: ApplyPage,
});
