 ...
 * @module routes/_website/our-staff
 */
...
export const Route = createFileRoute("/_website/our-staff")({
  head: () =>
    websiteHead({ title: "Our Staff", description: `Meet the dedicated team at ${SCHOOL.name}.` }),
...
/** Public staff directory with department filters. */
            ...
            <Card key={s.id} sx={{ height: "100%" }}>
              <CardContent sx={{ textAlign: "center" }}>
                ...
                <Typography variant="caption" color="text.secondary" display="block" sx={{ mb: 1 }}>
                  {STAFF_QUALIFICATIONS[s.id] ?? "Qualified educator"}
                </Typography>
                {s.classAssigned && (
