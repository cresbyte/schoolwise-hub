...
export const Route = createFileRoute("/_website/about")({
  head: () =>
    websiteHead({
      title: "About Us",
      description: `Learn about ${SCHOOL.name} — our history, vision, leadership team, and world-class facilities in Nakuru.`,
    }),
  component: AboutPage,
});
