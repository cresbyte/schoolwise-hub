 ...
 * @module routes/_website/academics
 */
...
export const Route = createFileRoute("/_website/academics")({
  head: () =>
    websiteHead({
      title: "Academics",
      description: `Academic programmes at ${SCHOOL.name} — CBC and 8-4-4 curricula, KCSE results, and term calendar.`,
    }),
