                    ...
                    <TableRow key={u.id} hover>
                      <TableCell>
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                          <Avatar sx={{ width: 32, height: 32, fontSize: 12, bgcolor: ROLE_COLORS[u.role] }}>{getInitials(u.name)}</Avatar>
                          <Box>
                      ...
                      <TableCell><Chip size="small" label={ROLE_LABELS[u.role]} sx={{ bgcolor: `${ROLE_COLORS[u.role]}19`, color: ROLE_COLORS[u.role], fontWeight: 600 }} /></TableCell>
