          ...
          <DialogContent>
            <Box className="printable">
              ...
              <Table size="small" sx={{ mb: 2 }}>
                ...
                <TableBody>
                  <TableRow><TableCell>Fee Payment ({PAYMENT_METHOD_LABELS[receipt.paymentMethod]}{receipt.mpesaCode ? ` · ${receipt.mpesaCode}` : ""})</TableCell><TableCell align="right">{formatKES(receipt.amount)}</TableCell></TableRow>
                </TableBody>
              </Table>
              <Divider sx={{ mb: 1 }} />
