...
export const Route = createFileRoute("/students")({
  head: () => ({ meta: [{ title: "Students — SchuleSmart" }] }),
  component: () => (
    <DashboardLayout>
      <StudentsPage />
    </DashboardLayout>
        ...
        actions={
          <>
            ...
            <RoleGuard roles={["admin", "headteacher"]}>
              <Button startIcon={<AddIcon />} variant="contained" onClick={() => navigate({ to: "/students/new" })}>
                Add Student
              </Button>
            </RoleGuard>
          </>
                      ...
                      <TableRow key={s.id} hover>
                        ...
                        <TableCell>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            <Link to="/students/$id" params={{ id: s.id }} style={{ fontWeight: 600, color: "#1565C0", textDecoration: "none" }}>
                        ...
                        <TableCell align="right">
                          <Tooltip title="View">
                            <IconButton size="small" onClick={() => navigate({ to: "/students/$id", params: { id: s.id } })}>
