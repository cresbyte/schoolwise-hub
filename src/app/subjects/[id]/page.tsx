...
import { GradeRule, Subject } from "@/lib/types";
...
export default function SubjectSettingsPage() {
  ...
  const addRule = () => {
    setRules([...rules, { grade: "", min: 0, max: 0, color: "#757575" }]);
  };
  ...
  const updateRule = (index: number, field: keyof GradeRule, value: string | number) => {
  ...
  return (
    <DashboardLayout>
      <PageHeader 
        ...
        actions={<Button startIcon={<ArrowBackIcon />} onClick={() => router.push("/subjects")}>Back</Button>}
      />
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                            ...
                            />
                            <Typography variant="caption">{rule.color}</Typography>
                          </Box>
                        </TableCell>
                        <TableCell>
                          <TextField 
