    ...
    <>
      ...
      <Card>
        <CardContent>
          ...
          <DataState loading={report.loading} error={report.error} data={report.data} onRetry={report.refetch} isEmpty={(d: any) => !d.subjectStats?.length} emptyMessage="No marks for this class/exam">
            {(data: any) => (
              <Table size="small">
                <TableHead>
                  <TableRow>
